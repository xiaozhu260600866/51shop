...
export default {
    ...
    methods: {
        ...
        infoSubmit() {
            ...
            this.addCartAjax({ infoId: info.id, num: info.bnum, type: "add", is_info: 1,pid:this.getParent(this).data.pid || 0 });
        },
        addCartAjax(data) {
			...
			this.postAjax(url,data).then(msg=>{
				if (msg.data.status == 2) {
					...
					this.getConfirm("享受本优惠需购买关联商品",msg2=>{
						this.goto(msg.data.url,1);
					})
