    ...
    <section>
        ...
        <span v-if="type == 1">
            ...
            <p class="fs-12 Arial fc-3 lh-20 h-20 surplus-time">
				<span class="Arial span">{{ days }}</span>
				<span class="plr3 fc-white">天</span>
				<span class="Arial span">{{ hours }}</span>
				<span class="fc-white">:</span>
				<span class="Arial span">{{ minutes }}</span>
				<span class="fc-white">:</span>
				<span class="Arial span">{{ seconds }}</span>
			</p>
        </span>
    </section>
</template>
...
.surplus-time .span{background: #fff;font-size: 22upx;color: #333;width: 20px;height: 20px;text-align: center;line-height: 20px;display: inline-block;margin: 0 2px;border-radius: 3px;}
