		...
		<div v-if="data.show">
			...
			<div class="ass-rule mt8 bgf plr15">
				...
				<div class="rule-con pb15">
					<p class="fs-14">支付开团或参团，邀请好友参团，在有效时间内达到成团人数则拼团成功，进行发货；若超进未达到拼团人数则拼团失败，系统将自动退款。</p>
				</div>
			</div>
			...
			<div id="show_footer">
				...
				<div class="right" v-if="data.detail.isMy && data.detail.group.leftNum > 0">
					<div class="r-nav">
						<div class="r-item cart r-item-yellow" @click="goto('/pages/order/buy/main?order_no='+data.detail.order_no,1)">查看订单</div>
					</div>
					<div class="r-nav">
				...
				<div class="right" v-if="!data.detail.isMy && data.detail.group.leftNum > 0">
					<div class="r-nav">
						<myform :append="true" :ruleform="ruleform" :vaildate="vaildate" @callBack="toBuy(0,1)">
							<div slot="content">
					...
					<div class="r-nav">
						<myform :append="true" :ruleform="ruleform" :vaildate="vaildate" @callBack="toBuy(data.detail.group.id,1)">
							<div slot="content">
				...
				<div class="right" v-if="data.detail.group.leftNum <= 0 && data.detail.isMy">
					<div class="r-nav">
						<myform :append="true" :ruleform="ruleform" :vaildate="vaildate" @callBack="goto('/pages/order/buy/main?order_no='+data.detail.order_no,1)">
							<div slot="content">
					...
					<div class="r-nav">
						<myform :append="true" :ruleform="ruleform" :vaildate="vaildate" @callBack="goto('/pages/index/main',2)">
							<div slot="content">
								<div class="r-item buy r-item-red" @click="goto('/pages/index/main',2)">更多拼团</div>
							</div>
						</myform>
					</div>
				</div>
