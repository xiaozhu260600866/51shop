	...
	<view>
		...
		<div v-if="data.show">
			<div class="weui-cells ass-pro mt0 p10">
				<!-- 循环开始 -->
				<div class="weui-cell mb10 bgf proItem" v-for="v in data.lists.data" @click="goto('/pages/group/show/index?id='+v.id,1 )">
					...
					<div class="weui-cell__bd proInfo">
						...
						<div class="count">
							<p class="fs-12 fc-9">已拼<span class="Arial">{{ v.self_num_ + v.self }}</span>件</p>
