		...
		<div class="" v-if="shareBtn == true">
			...
			<div class="pshare-dig">
				<div class="pshare-group">
					...
					<div class="group-item" @tap="shareFc()" v-if="data.diag"><!--  -->
		...
		<QSPopup ref="popup">
			<view class="flex_column">
				...
				<view class="flex_row marginTop2vh">
					...
					<button class="plr20" type="info" size="medium" @tap.prevent.stop="offCanvas()">取消</button>
				</view>
			</view>
		</QSPopup>
		<!-- 画布 -->
				...
				try {
					...
					const d = await getSharePoster({
						...
						// 产品图
							type: 'image',
							id: 'productImage',
							url: _this.getSiteName+'/upload/images/disAd/800_'+ _this.data.diag.poster_cover,
							serialNum: 0,
							allInfoCallback({
								drawArray
							}) {
						...
						{
							type: 'text',
							text: _this.data.user.nickname+'为你推荐',
							color: '#434343',
							serialNum: 4,
							id: 'userName',
							allInfoCallback({
