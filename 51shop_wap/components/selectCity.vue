<template>
	<dx-diag :title="title ? title :'请选择城市'" width="76%" :OFFicon="false" ref="areaDiag">
		...
		<!-- 	<view class="w-b40 pr15"><dx-button block round @click="toggleCity">取消</dx-button></view> -->
			<view class="w-b100"><dx-button type="success" block round @click="submit">确认</dx-button></view>
		</view>
	</dx-diag>
